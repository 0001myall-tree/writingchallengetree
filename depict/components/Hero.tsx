      ...
      <div className="text-center mb-16 relative">
        <div className="absolute top-[-40px] left-1/2 -translate-x-1/2 opacity-20 pointer-events-none">
             <svg width="200" height="100" viewBox="0 0 200 100">
                ...
                <text className="text-[10px] font-medium tracking-[0.2em] fill-[#e86a33]">
        ...
        {/* RFP 4-1. 예상 소요 시간 표기 */}
        <p className="text-[10px] text-gray-400 tracking-widest">예상 소요 시간 : 약 2~3분</p>
      </div>
      ...
      <div className="relative mb-24 px-4 md:px-0">
        <div className="relative w-full h-[500px] md:h-[650px] overflow-hidden rounded-sm shadow-2xl group">
          ...
          <div className="absolute bottom-12 left-10 md:left-16 text-white max-w-lg">
            <p className="text-[10px] tracking-[0.4em] mb-4 font-bold uppercase opacity-80 underline underline-offset-8 decoration-orange-500">G-Kangs Publishing Lab</p>
          ...
          <div className="absolute top-8 right-8 hidden md:block">
            <div className="p-8 border border-white/20 backdrop-blur-xl bg-black/20 text-white rounded-sm w-64">
              <p className="text-[10px] tracking-widest mb-4 font-bold text-orange-400 uppercase">Diagnosis Sample</p>
              <div className="blur-result select-none opacity-50 space-y-2">
                ...
                <p className="text-[10px] leading-relaxed">단 한 마디로 백 마디를 대신하는...</p>
                <div className="h-2 w-full bg-white/20 rounded"></div>
                <div className="h-2 w-3/4 bg-white/20 rounded"></div>
              </div>
              <p className="mt-6 text-[8px] text-white/40 italic text-center">정식 결과는 테스트 완료 후 공개됩니다</p>
            </div>
          </div>
        </div>
