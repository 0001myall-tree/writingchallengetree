    ...
    <div className="min-h-screen flex flex-col items-center selection:bg-orange-200">
      ...
      <footer className="w-full bg-[#f8f5f0] mt-24 py-20 px-6 border-t border-orange-100 text-gray-600">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          <div className="mb-6">
            <p className="text-[10px] tracking-[0.4em] text-orange-400 mb-2 font-bold uppercase">Publisher</p>
          ...
          <div className="mb-12 w-full max-w-md">
            <a 
              ...
              className="group block bg-white border-2 border-[#e86a33] text-[#e86a33] hover:bg-[#e86a33] hover:text-white transition-all duration-300 px-8 py-6 rounded-sm shadow-sm transform hover:-translate-y-1"
            >
              <span className="text-lg md:text-xl font-bold leading-tight block">
                [막힐 때 바로 찾는 묘사 처방전]<br />
                펀딩 페이지 바로 가기
              </span>
              <span className="mt-2 text-[10px] tracking-widest uppercase opacity-60 block">Visit Tumblbug Project</span>
            </a>
          </div>



          <div className="w-full pt-12 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase tracking-widest text-gray-400">
