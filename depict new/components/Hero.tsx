  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-16 relative">
        ...
        <button onClick={onStart} className="bg-[#e86a33] text-white px-10 md:px-14 py-5 md:py-6 text-sm font-bold tracking-widest hover:bg-[#d55a2a] transition-all transform hover:-translate-y-1 rounded-sm shadow-xl active:scale-95 mb-16">
          진단 시작하기
        </button>
