...
export const RESULTS: Record<WriterType, Result> = {
  ...
  MICROSCOPE: {
    ...
    name: '현미경형',
    definition: "감정 분석형",
    description: "당신은 감정을 그냥 흘려보내지 않습니다.\n왜 이런 감정이 생겼는지, 어디서 비롯됐는지, 구조를 파고듭니다.\n관찰력과 통찰력이 뛰어나고, 감정의 결을 세밀하게 포착합니다.\n\n다만 감정을 충분히 느끼기 전에 분석이 먼저 작동할 수 있습니다.\n설명이 앞서면 독자가 감정에 잠기기 전에 머리를 쓰게 됩니다.\n\n이 타입에게 필요한 것은\n감정을 설명하는 글이 아니라,\n독자가 스스로 감정을 체험하게 만드는 글입니다.",
